...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(457, 77);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(541, 75);
			...
			this->ClientSize = System::Drawing::Size(849, 678);
...
#pragma endregion
	...
	private: System::Void Fan_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^ e) {
		...
		SolidBrush^brush1 = gcnew SolidBrush(Color::Green);//画底座
	...
	private: System::Void DrawAnimated(System::Object^  sender, System::EventArgs^  e, int drawflag){
				 ...
				 if (drawflag == 1)
				 {
					 ...
					 brush2 = gcnew SolidBrush(Color::Blue);  //画蓝色的叶片.  
...

				 {
					 ...
					 brush2 = gcnew SolidBrush(this->BackColor); //画蓝色的叶片.   
